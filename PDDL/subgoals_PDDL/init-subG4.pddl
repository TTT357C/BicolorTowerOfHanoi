(define (problem move_r4_to_goal) (:domain hanoiPLUS)
(:objects
...
(:init
	...
	(located r1 rod1) (located w2 rod1) 
	(located r3 rod1) (located w4 rod1)

	(located w1 rod2) (located r2 rod2) 
	(located w3 rod2) (located r4 rod2) 
	
	(=(disks_number rod1)4) (=(disks_number rod2)4) 
	(=(disks_number rod3)0) 

	(on r1 w2)(on w2 r3)(on r3 w4)
	(on w1 r2)(on r2 w3)(on w3 r4)
...
(:goal (and
	...
	(clear w4) (clear r1) 
	(not(clear w1)) (not(clear w2)) (not(clear w3)) (not(clear r4))  
	(not(clear r2)) (not(clear r3))  
	
	(on r1 w1)(on w1 w2)(on w2 r2)(on r2 r3)(on r3 w3)(on w3 r4) 
	 
	(=(disks_number rod1)0) (=(disks_number rod2)7) 
	(=(disks_number rod3)1) 
