...
(:init
	...
	(on r1 w2)(on w2 r3)(on r3 w4)(on w4 r5)(on r5 w6)
	(on w1 r2)(on r2 w3)(on w3 r4)(on r4 w5)(on w5 r6)
...
(:goal (and
	...
	(not(clear w2)) (not(clear w3)) (not(clear w4)) (not(clear w5)) (not(clear r6))
	(not(clear w1)) (not(clear r2)) (not(clear r3)) (not(clear r4)) (not(clear r5))
