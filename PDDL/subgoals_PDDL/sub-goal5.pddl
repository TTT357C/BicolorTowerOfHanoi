...
(:init
	...
	(on r1 w1) (on w1 w2) (on w2 r2)(on r2 r3)(on r3 w3) 
	(on w3 w4) (on w4 r4) (on r4 w5)
...
(:goal (and
	...
	(located w1 rod1) (located w2 rod1) (located w3 rod1) (located w4 rod1) (located w5 rod1) 
	(located r1 rod2) (located r2 rod2) (located r3 rod2) (located r4 rod2) (located r5 rod2) 

	(clear w1) (clear r1) 
	(not(clear w2)) (not(clear w3)) (not(clear w4)) (not(clear w5)) 
	(not(clear r2)) (not(clear r3)) (not(clear r4)) (not(clear r5)) 
	
	(on w1 w2) (on w2 w3) (on w3 w4) (on w4 w5) 
	(on r1 r2) (on r2 r3) (on r3 r4) (on r4 r5) 
