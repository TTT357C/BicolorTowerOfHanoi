# A simple application of the zcanvas module
...
canvas = ZCanvas(rootWindow, width=1000, height=800, bg="white", scalewidget=False)
...
def test2():
    ...
    rootwin1 = tk.Tk()
    canvas1 = ZCanvas(rootwin1, width=1000, height=800, bg="white", scalewidget=False)
    ...
    rootwin2 = tk.Tk()
    canvas2 = ZCanvas(rootwin2, width=1000, height=800, bg="gray90")
